...
test('set', t => {
  ...
  const o1 = dotProp.set(fixture1(), 'foo.x', 2, true)
  t.is(fixture1().foo.x, 2)
  t.is(o1, fixture1())

  dotProp.set(fixture1(), 'foo.bar.baz', 3, true)
  ...
  dotProp.set(fixture1(), 'foo.fake.fake2', 'fake', true)
...
test('delete', t => {
  ...
  t.true(dotProp.delete(temp, 'foo.bar.baz.c'))
  t.is(temp.foo.bar.baz.c, undefined)

  const t2 = { top: {} }
  t.true(dotProp.delete(t2, 'top'))
  t.is(t2.top, undefined)
